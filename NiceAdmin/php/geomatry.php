...
function request_water($id){
	...
	if($GLOBALS['field_volume'] < $row["currentVol"]-$row["currentUsage"]){
		echo "<br> water can be issue by canal ".$id."<br>amount".($row["currentVol"]-$row["currentUsage"]);
	}
}
